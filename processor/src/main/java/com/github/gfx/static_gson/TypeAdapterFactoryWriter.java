...
public class TypeAdapterFactoryWriter {
    ...
    private final String typeAdapterFactoryClassName;
    ...
    public TypeAdapterFactoryWriter(StaticGsonContext context, ModelDefinition model) {
        ...
        typeAdapterFactoryClassName = createTypeAdapterFactoryClassName(model.modelType);
    }

    static String createTypeAdapterFactoryClassName(ClassName modelType) {
        return modelType.simpleNames().stream().collect(Collectors.joining("$")) + "$TypeAdapterFactory";
    }
    ...
    TypeSpec buildTypeSpec() {
        TypeSpec.Builder type = TypeSpec.classBuilder(typeAdapterFactoryClassName);
        type.addJavadoc("<p>This class is dynamically loaded by {@link $T}.</p>\n\n", Types.StaticGsonTypeAdapterFactory);
        type.addJavadoc("<p>Generated by {@code $T}.</p>\n", StaticGsonProcessor.class);
